  ...
  const handleComplaintSubmit = async (e) => {
    ...
    try {
      ...
      if (cancelOrder) {
        ...
        // Fetch to update the hasComplaint flag and reveal the Cancel Order button
        fetchAssignedOrders(false)
      }
    } catch (err) {
  ...
  return (
    <div className="flex flex-col gap-8 text-left w-full pb-20 max-w-6xl">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-3xl font-black text-slate-800 tracking-tight">Rider Delivery Board</h1>
          <p className="text-sm text-gray-500 font-medium">Manage and complete assigned tiffin deliveries across the city.</p>
        </div>

        {/* Modern Segmented Tabs */}
        <div className="bg-emerald-50/50 p-1 rounded-2xl flex border border-emerald-100/50 w-full md:w-auto shadow-sm">
          <button
            onClick={() => {
              setActiveTab('available')
              fetchAvailableOrders(false)
            }}
            className={`flex-1 md:flex-initial py-2 px-6 rounded-xl font-extrabold text-xs cursor-pointer transition-all duration-200 ${
              activeTab === 'available'
      ...
      {/* Stats Row */}
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 w-full">
        <Card className="p-5 border border-emerald-50 bg-gradient-to-br from-white to-emerald-50/10 shadow-sm relative overflow-hidden" hoverable={true}>
          <div className="flex justify-between items-center">
            <div>
              <p className="text-[10px] font-black text-gray-400 uppercase tracking-wider">Awaiting Pickup</p>
          ...
          <div className="absolute -bottom-1 -right-1 w-8 h-8 rounded-full bg-amber-500/5 blur-md"></div>
        </Card>

        <Card className="p-5 border border-emerald-50 bg-gradient-to-br from-white to-emerald-50/10 shadow-sm relative overflow-hidden" hoverable={true}>
          <div className="flex justify-between items-center">
            <div>
              <p className="text-[10px] font-black text-gray-400 uppercase tracking-wider">In Transit</p>
              <h3 className="text-2xl font-black text-slate-800 mt-1">
          ...
          <div className="absolute -bottom-1 -right-1 w-8 h-8 rounded-full bg-blue-500/5 blur-md"></div>
        </Card>

        <Card className="p-5 border border-emerald-50 bg-gradient-to-br from-white to-emerald-50/10 shadow-sm relative overflow-hidden" hoverable={true}>
          <div className="flex justify-between items-center">
            <div>
              <p className="text-[10px] font-black text-gray-400 uppercase tracking-wider">Delivering Nearby</p>
              <h3 className="text-2xl font-black text-slate-800 mt-1">
                {orders.filter(o => o.status === 'Nearby').length}
              </h3>
            </div>
        ...
        <Card className="p-5 border border-emerald-50 bg-gradient-to-br from-white to-emerald-50/10 shadow-sm relative overflow-hidden" hoverable={true}>
          <div className="flex justify-between items-center">
            <div>
              <p className="text-[10px] font-black text-gray-400 uppercase tracking-wider">Opportunities</p>
              <h3 className="text-2xl font-black text-slate-800 mt-1">
          ...
          <div className="absolute -bottom-1 -right-1 w-8 h-8 rounded-full bg-purple-500/5 blur-md"></div>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
        {activeTab === 'assigned' ? (
          orders.length > 0 ? (
                ...
                <div className="px-5 pb-5 pt-0 flex flex-col gap-3">
                  ...
                  <div className="flex gap-3">
                    <Button
                      ...
                      className="flex-1 py-2.5 rounded-2xl border-emerald-100 hover:bg-emerald-50/50 flex items-center justify-center gap-1.5 text-xs font-bold cursor-pointer text-gray-600"
                    >
            ...
            <Card className="p-8 text-center text-gray-400 col-span-full" hoverable={false}>
